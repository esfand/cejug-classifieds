...
package net.java.dev.cejug.classifieds.server.contract {
    ...
    [Bindable]
    [RemoteClass(alias="net.java.dev.cejug.classifieds.server.contract.AdvertisementTypeCollection")]
    public class AdvertisementTypeCollection {

        private var _advertisementType:ListCollectionView;

        public function get advertisementType():ListCollectionView {
